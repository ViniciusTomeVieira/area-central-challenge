            ...
            <div class="col-lg-12">
              <form class="card" action="app/core/produtos.php" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="codigo_de_barras" placeholder="78978978978978">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="number" class="form-control text-right" name="valor_unitario" aria-label="Valor" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer text-left" style="display: flex; justify-content: space-between">
                  ...
                  <div>
                    <button type="submit" name="cadastrar_produto" class="btn btn-primary">Confirmar</button>
                  </div>
                </div>
              </form>
            </div>
