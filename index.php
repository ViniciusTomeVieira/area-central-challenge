        ...
        <div class="my-3 my-md-5">
                ...
                <div class="card">
                  <div class="card-body p-3 text-center">  
                    <?php
                      ...
                      $result = $mysqli->query("SELECT COUNT(*) AS `count` FROM `produtos`");
                      $row = $result->fetch_array();
                      $produtos = $row['count'];
                    ?>                   
                    <div class="h1 m-0"><?php echo $produtos; ?></div>
	      ...
	      <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  ...
                  <?php
                      $mysqli = new mysqli('localhost', 'root', '', 'areacentral') or die(mysqli_error($mysqli));
                      $result = $mysqli->query("SELECT COUNT(*) AS `count` FROM `vendas`");
                      $row = $result->fetch_array();
                      $vendas = $row['count'];
                    ?>                
                    <div class="h1 m-0"><?php echo $vendas ?></div>
