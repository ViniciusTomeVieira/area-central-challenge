                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <?php if($row['excluido']): ?>
                        <tr>
                            ...
                            <td>
                              <a class="icon"  title="Retirar da lixeira" href="./app/core/produtos.php?reciclar_produto=<?php echo $row['id']; ?>" >
                               <i class="fe fe-refresh-ccw"></i>
                              </a>					    
                            </td> 
                            <td>
                              <a class="icon" title="Deletar permanentemente" href="./app/core/produtos.php?deletar_produto=<?php echo $row['id']; ?>">
