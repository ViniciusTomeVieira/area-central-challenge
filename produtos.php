                      ...
                      <tbody>
                        <?php while($row = $result->fetch_assoc()):  ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $row['data_ultima_venda']; ?>
                            </td>
                            <td>
                              <?php echo $row['total_vendas']; ?>
                            </td>                         
                            <td>
                              <a class="icon" title="Editar Produto" href="./form-produto-edit.php?editar_produto=<?php echo $row['id']; ?>">
                                <i class="fe fe-edit"></i>
                              </a>			    
                            </td>
                            <td>
                              <a class="icon" title="Mover para lixeira" href="./app/core/produtos.php?reciclar_produto=<?php echo $row['id']; ?>">
